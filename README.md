...
- [`Chapter 01`: Hello Cargo](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch01_hello_cargo/src/main.rs)
- [`Chapter 02`: Guessing Game](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch02_guessing_game/src/main.rs)
- [`Chapter 03`: Functions](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch03_functions/src/main.rs)
- [`Chapter 04`: Ownership](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch04_ownership/src/main.rs)
- [`Chapter 05`: Structure](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch05_structure/src/main.rs)
- [`Chapter 06`: Enum](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch06_enum/src/main.rs)
- [`Chapter 07`: Module](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch07_module/src)
- [`Chapter 08`: Collections](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch08_collections/src)
- [`Chapter 09`: Errors](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch09_errors/src)
- [`Chapter 10`: Generic Types](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch10_generic_types/src)
- [`Chapter 11`: Test](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch11_test)
- [`Chapter 12`: I/O Project](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch12_io_project)
- [`Chapter 13`: Iterator and Closure](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch13_iterator_and_closure)
- [`Chapter 14`: Cargo and Crates I/O](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch14_cargo_and_crates_io)
- [`Chapter 15`: Smart Pointers](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch15_smart_pointer)
- [`Chapter 16`: Concurrency](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch16_concurrency)
- [`Chapter 17`: OOP](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch17_OOP/src/main.rs)
- [`Chapter 18`: Patterns](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch18_patterns/src/lib.rs)
- [`Chapter 19`: Advanced](https://github.com/DonghyungKo/til/blob/master/rust/the-programming-language-rust/ch19_advanced/src/lib.rs)
- [`Chapter 20`: Http Project](https://github.com/DonghyungKo/til/tree/master/rust/the-programming-language-rust/ch20_http_project/src)


## Data Structures Implementations
- [`Item 01`: Vec<T> (Heap-allocated Array)](https://github.com/DonghyungKo/til/tree/master/rust/data-structures/vec/src)
- [`Item 02`: Linked List](https://github.com/DonghyungKo/til/blob/master/rust/data-structures/linked_list/src/single_linked_list.rs)
- [`Item 03`: Hash Table](https://github.com/DonghyungKo/til/tree/master/rust/data-structures/hashtable/src/lib.rs)
- [`Item 04`: Binary Search Tree](https://github.com/DonghyungKo/til/tree/master/rust/data-structures/btree/src/lib.rs)
- [`Item 05`: Trie](https://github.com/DonghyungKo/til/tree/master/rust/data-structures/trie/src/lib.rs)

## Crust of Rust

- [`Item 01`: Iterator](https://github.com/DonghyungKo/til/blob/master/rust/crust-or-rust/iterator/src/main.rs)

## Leetcode
- [`No.121`: Best Time to Buy and Sell Stock](https://github.com/DonghyungKo/til/blob/master/rust/leetcode/no121_Best_Time_To_Buy_And_Sell_Stock/src/lib.rs)
- [`No.136`: Single Number](https://github.com/DonghyungKo/til/blob/master/rust/leetcode/no136_Single_Number/src/lib.rs)
- [`No.169`: Majority Element](https://github.com/DonghyungKo/til/blob/master/rust/leetcode/no169_Majority_Element/src/lib.rs)
- [`No.283`: Move Zeroes](https://github.com/DonghyungKo/til/blob/master/rust/leetcode/no283_Move_Zeroes/src/lib.rs)
...
- [`Item 01`: Generics class and generic methods](https://github.com/DonghyungKo/til/blob/master/java/java201/src/Generic.java)
...
- [`ToyProject`: Book Store](https://github.com/DonghyungKo/til/tree/master/java/spring101/jpashop)
